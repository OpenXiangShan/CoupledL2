...
//  val need_data_a = dirResult_s3.hit && (req_get_s3 || req_acquireBlock_s3)
  ...
  val returnData_s3 = d_s3.fire && d_s3.bits.task.opcode === GrantData
  MyPerf("retrun_data_in_s3", returnData_s3)
  val returnData_s4 = d_s4.fire && d_s4.bits.task.opcode === GrantData
  MyPerf("return_data_in_s4", returnData_s4)
  val returnData_s5 = d_s5.fire && d_s5.bits.task.opcode === GrantData
