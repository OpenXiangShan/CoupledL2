...
import coupledL2.mbist._
import coupledL2.utils.SRAMTemplate.{nodeId, wrapperId}
...
println(s"L2 addSink-------------------------------------------sram_wrapperId_sigName is sram_${wrapperId}_${sigName}")
...
println(s"L2 addSource-------------------------------------------sram_idx+firstToBeBroadCast_sigName is sram_${idx + firstToBeBroadCast}_${sigName}")
println(s"L2 addSource-------------------------------------------idx is ${idx}")
println(s"L2 addSource-------------------------------------------firstToBeBroadCast is ${firstToBeBroadCast}")
...
(
  ...
  // mbist support
  hasMbist: Boolean = true, hasShareBus: Boolean = true,
...
println(s"L2-------------------------------------------------------------SRAM NO running printing LiHe nodeId is ${nodeId}")
println(s"L2-------------------------------------------------------------SRAM NO running printing LiHe wrapperId is ${wrapperId}")
